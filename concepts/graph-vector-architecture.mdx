...
<CardGroup cols={2}>
  ...
  <Card title="Query Patterns" href="/hql/queries" icon="code">
    Learn to write hybrid queries
  </Card>
  <Card title="RAG Guide" href="/guides/rag-applications" icon="book">
    Build retrieval-augmented generation systems
  </Card>
  <Card title="Performance Tuning" href="/advanced/performance" icon="gauge">

...
<CardGroup cols={2}>
  <Card title="HelixQL Guide" href="/hql/overview" icon="code">
    Learn the full HelixQL syntax
  </Card>
  <Card title="Schema Design" href="/hql/schema" icon="pen-ruler">
    Best practices for defining schemas
  </Card>
  <Card title="TypeScript SDK" href="/sdks/typescript" icon="js">
    Use generated types in your app
  </Card>
  <Card title="Query Syntax" href="/api/query-syntax" icon="terminal">
    Explore advanced query syntax
  </Card>
</CardGroup>
